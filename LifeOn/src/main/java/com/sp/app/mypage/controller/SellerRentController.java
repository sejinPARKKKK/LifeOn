...
@Slf4j
@RequestMapping("/sellerRent/*")
public class SellerRentController {
	private final RentServiceOrder service;
	...
	public String list(
		...
		try {
			...
			List<RentProductOrder> list = service.listRentProductOrder(map);
		...
		return "mypage/seller/seller_rent";
	}
}