...
<main class="min-vh-100">
    ...
    <div class="body-title">
    	<em style="padding-bottom: 5px; font-size: 30px; font-weight: 800; text-shadow: 2px 2px 5px rgba(0, 0, 0, 0.3);">어떤 이야기가 궁금신가요?!</em>
		<div style="display: flex; justify-content: center; margin-top: 10px;">
		   	<div>
			   	<form name="searchForm" style="display: inline-flex; align-items: center;">
					...
					<!-- 검색상자 -->
					<input type="search" name=kwd value="${kwd}" class="searchBox" placeholder="궁금한 이야기를 검색해보세요!">
					<!-- 검색버튼 -->
			   		<button class="mybtn" style="margin-right: 2px;" onclick="searchList();">검색&nbsp;<i class="bi bi-search"></i></button>
				   	<!-- 새로고침 버튼 -->
					<button type="button" class="ssbtn" style="height: 40px;" onclick="location.href='${pageContext.request.contextPath}/lounge2/daily';" title="새로고침">새로고침&nbsp;<i class="bi bi-arrow-repeat"></i></button>
		   		</form>
			</div>
		</div>
	</div>
		...
		<div class="body-content">
			...
			<div class="main_content">
				...
				<div class="main_menu">
			   		...
			   		<div>
						<!-- 글쓰기 버튼 -->
						<button class="ssbtn" onclick="location.href='<c:url value='daily/write'/>'">글쓰기&nbsp;<i class="bi bi-pencil"></i></button>
					</div>
				</div>
...
function searchList() {
	...
	let url = '${pageContext.request.contextPath}/lounge2/daily';
