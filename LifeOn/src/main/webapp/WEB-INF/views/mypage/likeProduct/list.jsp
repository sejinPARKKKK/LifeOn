...
<main class="d-flex flex-column min-vh-100" style="padding-top: 84px; padding-left: 210px;">
    ...
    <div class="container d-flex flex-column align-items-center">
        <div class="sejin-container">
            <div class="sejin-title">관심 상품</div>
                ...
                <table class="sejin-table">
                    <thead>
                        <tr>
                            ...
                            <th>상품명</th>
                            <th>상품사진    
	                            <a style="font-size: 12px; color: gray; margin-top: 5px;">
	        						사진을 누르면 상품정보 확인 할 수 있어용
	   					 		</a>
   					 		</th>
                            <th></th>
                        </tr>
                    	...
                    	<c:forEach var="dto" items="${list}" varStatus="status">
                    		<tr>
                    			...
                    			<td style="text-align: center;">
                    				<a href="${pageContext.request.contextPath}/market/together/detail?pnum=${dto.pnum}">
                    					<img src="${pageContext.request.contextPath}/uploads/product/${dto.pph}" alt="상품 이미지" width="50">
                    				</a>
                    			</td>
                    			<td style="text-align: right;">
                    				<button class="btn btn-delete" onclick="location.href='${pageContext.request.contextPath}/market/together/cancel?pnum=${dto.pnum}'">취소하기</button>
                    			</td>
