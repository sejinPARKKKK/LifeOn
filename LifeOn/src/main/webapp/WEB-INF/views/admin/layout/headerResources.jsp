...
<link rel="stylesheet" href="${pageContext.request.contextPath}/dist/css/core2.css" type="text/css">
<link rel="stylesheet" href="${pageContext.request.contextPath}/dist/css/menu2.css" type="text/css">
